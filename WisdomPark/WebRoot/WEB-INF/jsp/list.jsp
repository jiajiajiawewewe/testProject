<%@page import="com.wisdom.beans.Article"%>
<%@page import="com.wisdom.dao.ArticleDao"%>
<%@page import="com.wisdom.beans.Comment"%>
		...
		<table style="width:100%;" cellSpacing="0" cellPadding="0">
			<tr>
				...
				<td style="text-align:left; padding-bottom:5px;">
					<a href="publish" target="_blank"><img src="/WisdomPark/forum/images/post/post.gif" /></a>
				</td>
			</tr>
		</table>
		<TABLE class="mainbox tableborder" cellSpacing=0 cellPadding=0 style="width:100%">
			...
			<%-- <%
			 ...
			 %> --%>
			   ...
			   List<Article> articles = dao.findArticles();
				...
				<TR class=trout onmouseover="this.className='tron'" onmouseout="this.className='trout'">
					<TD class=list1>
						<A href="SaveComment?id=${article.id}">
							<IMG border=0   src="/WisdomPark/forum/images/top3.gif" />
						</A>
					</TD>
					<TD class=list2>
						<SPAN>
					...
					<TD class=list5>
						...
						<A class=font10 href="">${article.getLastUpdateTime()}</A><BR/>
						by：<A >${article.getLastUpdatePerson()}</A>
					</TD>
				</TR>
			</c:forEach>
			<%-- <%
